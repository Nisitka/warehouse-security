...
directory_data_train= '/home/nisitka/PycharmProjects/classificalNet/dataset/Train' #Указываем путь к обучающей выборке train_data_dir
directory_data_validation= '/home/nisitka/PycharmProjects/classificalNet/dataset/Validation'  #Указываем путь к проверочной выборке validation_data_dir

# Сразу устанавливаем необходимые параметры

train_sample = 261
validation_sample = 261
epochs = 55
lot_size = 2  # batch_size
...
pattern.save('network3')  #Сохранение модели
