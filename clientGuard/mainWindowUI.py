...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.verticalLayout_7.addWidget(self.nameGuardLabel)
        ...
        self.repeatConnectButton = QtWidgets.QPushButton(self.settingsTab)
        self.repeatConnectButton.setGeometry(QtCore.QRect(90, 90, 201, 41))
